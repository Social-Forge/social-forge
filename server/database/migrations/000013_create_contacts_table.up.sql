...
CREATE INDEX IF NOT EXISTS idx_contacts_tenant_id ON contacts(tenant_id) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_contacts_channel_id ON contacts(channel_id) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_contacts_channel_user_id ON contacts(channel_user_id) WHERE deleted_at IS NULL;
CREATE UNIQUE INDEX IF NOT EXISTS idx_contacts_unique_non_null_phone ON contacts(phone) WHERE phone IS NOT NULL;
CREATE UNIQUE INDEX IF NOT EXISTS idx_contacts_unique_non_null_email ON contacts (email) WHERE email IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_contacts_is_active ON contacts(is_active) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_contacts_is_blocked ON contacts(is_blocked) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_contacts_created_at ON contacts(created_at) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_contacts_updated_at ON contacts(updated_at) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_contacts_active_tenant ON contacts(tenant_id) WHERE deleted_at IS NULL AND is_active = true;
CREATE INDEX IF NOT EXISTS idx_contacts_last_contact ON contacts(last_contact_at) WHERE deleted_at IS NULL AND last_contact_at IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_contacts_tags ON contacts USING GIN(tags) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_contacts_label_ids ON contacts USING GIN(label_ids) WHERE deleted_at IS NULL;
...
CREATE OR REPLACE TRIGGER trigger_contacts_search_update
    BEFORE INSERT OR UPDATE OF name, email, phone, tags ON contacts
    FOR EACH ROW
    EXECUTE FUNCTION contacts_search_update();

CREATE MATERIALIZED VIEW mv_contact_summaries AS
SELECT 
    tenant_id,
    channel_id,
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_mv_contact_summaries_pk ON mv_contact_summaries (tenant_id, channel_id);
CREATE INDEX IF NOT EXISTS idx_mv_contact_summaries_tenant ON mv_contact_summaries (tenant_id);
CREATE INDEX IF NOT EXISTS idx_mv_contact_summaries_channel ON mv_contact_summaries (channel_id);
CREATE INDEX IF NOT EXISTS idx_mv_contact_summaries_active ON mv_contact_summaries (tenant_id, channel_id, active_contacts);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_mv_contact_search_pk ON mv_contact_search (id);
CREATE INDEX IF NOT EXISTS idx_mv_contact_search_tenant ON mv_contact_search (tenant_id);
CREATE INDEX IF NOT EXISTS idx_mv_contact_search_vector ON mv_contact_search USING GIN(search_vector);
CREATE INDEX IF NOT EXISTS idx_mv_contact_search_tags ON mv_contact_search USING GIN(tags);
CREATE INDEX IF NOT EXISTS idx_mv_contact_search_name ON mv_contact_search (name);
CREATE INDEX IF NOT EXISTS idx_mv_contact_search_email ON mv_contact_search (email);
CREATE INDEX IF NOT EXISTS idx_mv_contact_search_phone ON mv_contact_search (phone);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_mv_recent_contacts_pk ON mv_recent_contacts (id);
CREATE INDEX IF NOT EXISTS idx_mv_recent_contacts_tenant ON mv_recent_contacts (tenant_id);
CREATE INDEX IF NOT EXISTS idx_mv_recent_contacts_last_contact ON mv_recent_contacts (last_contact_at DESC);
CREATE INDEX IF NOT EXISTS idx_mv_recent_contacts_days_since ON mv_recent_contacts (days_since_contact);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_mv_contact_tags_pk ON mv_contact_tags_analytics (tenant_id, channel_id, tag);
CREATE INDEX IF NOT EXISTS idx_mv_contact_tags_tag ON mv_contact_tags_analytics (tag);
CREATE INDEX IF NOT EXISTS idx_mv_contact_tags_active ON mv_contact_tags_analytics (tenant_id, channel_id, active_count);
CREATE INDEX IF NOT EXISTS idx_mv_contact_tags_blocked ON mv_contact_tags_analytics (tenant_id, channel_id, blocked_count);
...
CREATE OR REPLACE TRIGGER trigger_refresh_contact_mvs
