CREATE TABLE IF NOT EXISTS labels (
  ...
  agent_owner_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
  ...
  CONSTRAINT chk_label_agent_id_name UNIQUE (agent_owner_id, name),
  CONSTRAINT chk_label_agent_id_slug UNIQUE (agent_owner_id, slug)
);
