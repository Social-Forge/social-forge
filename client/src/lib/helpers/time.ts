...
export function formatToPostgresTimestampV2(date: Date): string {
	...
	// Milliseconds dengan 3 digit seperti contoh "995"
	const milliseconds = String(date.getMilliseconds()).padStart(3, '0');

	// Get timezone offset in format +0700
	const timezoneOffset = -date.getTimezoneOffset(); // negate to get correct sign
